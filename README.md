...
GET /api/devs → returns the list of developers

POST /api/devs → adds a new developer to the list

The frontend uses Fetch API to interact with the backend dynamically.

All developer data is stored in a JSON file for simplicity.
...
Passionate about learning, clean code, and real-world web apps

“DevConnect may be simple — but it demonstrates complete full-stack integration in one page.”
